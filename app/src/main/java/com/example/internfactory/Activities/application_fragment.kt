...
import com.example.internfactory.modules.ApplyInternship_response
...
class application_fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val call = retrofitAPI.internshipquestion((activity as activity_Dashboard).internshipId,"Bearer " + (activity as activity_Dashboard).token)
