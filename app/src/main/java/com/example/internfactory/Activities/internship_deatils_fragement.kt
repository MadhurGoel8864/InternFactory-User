 ...
 * Use the [internship_deatils_fragement.newInstance] factory method to
...
class internship_deatils_fragement : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment internship_deatils_fragement.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            internship_deatils_fragement().apply {
